...
namespace RlssCandidateDetails.RefreshToken.Database.dbInishalize
{
    public class dbCreator
    {
        ...
        public bool CreateDatabase(string location)
        {
            ...
            path = System.IO.Path.Combine(path,"..\\RlssCandidateDetails.RefreshToken");
            ...
            try
            {
                ...
                dbSqliteConnection connection = new dbSqliteConnection();
